...
*/
    ...
    //media upload
    jQuery(".help-media-upload").click( function( event ) {
                var activeFileUploadContext = jQuery(this).parent();
                var relid = jQuery(this).attr('rel-id');
                ...
                custom_file_frame.on( "select", function() {
                    ...
                    jQuery('.help-media-upload',activeFileUploadContext).hide();
                    jQuery('.help-media-upload-media-remove',activeFileUploadContext).show();
    ...
    jQuery(".help-media-upload-media-remove").click( function( event ) {
        var activeFileUploadContext = jQuery(this).parent();
        var relid = jQuery(this).attr('rel-id');
        ...
        jQuery('#' + relid).val('');
        jQuery('.help-media-upload-media-remove',activeFileUploadContext).hide();
        jQuery('.help-media-upload',activeFileUploadContext).show();
